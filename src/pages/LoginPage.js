      ...
      <div>
        ...
        <div className="backdrop-blur-[100px] w-full h-screen fixed ">
          ...
          <form onSubmit={handleLogin} className="w-[700px] h-[700px] mx-auto mt-32 p-10 flex items-center flex-col justify-around">
            <div className='flex flex-col items-center space-y-5 mb-1'>
            ...
            <div className="flex items-center flex-col  space-y-3  p-4">
              <button type="submit" className="w-[120%] bg-[#8A3CFA] h-[70px] font-bold text-3xl rounded-lg hover:bg-[#AB70FD] hover:scale-105 transition duration-300   ">Login</button> 
