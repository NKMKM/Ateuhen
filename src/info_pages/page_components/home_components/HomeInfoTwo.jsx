  ...
  return (
    <div className='w-[85%] mx-auto my-40 '>
        <div className='flex flex-row justify-between items-center'>
          <h1 className='w-1/2 text-7xl font-bold text-[#8A3CFA] '>Discover the Exciting Features of Ateuhen's Competitive Gaming Platform </h1>
          <p className='w-1/2 text-3xl font-thin '>Ateuhen caters to gamers of all skill levels, ensuring everyone can compete. Our ELO-based ranking system pairs players with similar abilities, creating a balanced environment. Whether you're a novice or a pro, there's a place for you here.</p>
        </div>
