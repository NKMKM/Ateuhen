        ...
        <div className='relative flex flex-col items-center'>
            ...
            <div className='flex bottom-0 flex-row space-x-7 w-[85%] mx-auto  my-48 z-20 '>
                <div className='bg-white/10 rounded-lg h-[700px] w-1/3 flex flex-col lift-on-hover backdrop-blur-lg '>
                    ...
                    <button className='w-[90%] h-[50px] mt-10 border-2 border-white rounded-lg mx-auto hover:scale-105 hover:bg-white hover:text-black hover:font-bold transition duration-300'>Get Started</button>
                </div>
                <div className='bg-white/10 rounded-lg h-[700px] w-1/3 flex flex-col lift-on-hover backdrop-blur-lg'>
                    <div className='p-6'>
                        <p>Standart Plan</p>
